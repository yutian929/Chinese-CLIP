...
if __name__ == "__main__":
    ...
    if args.convert_text:
        ...
        text_outputs = [ct.TensorType(name="text_features")]
        ...
        print(f"Text model converted to CoreML and saved at: {text_coreml_model_path}")
    ...
    if args.convert_vision:
        ...
        image_coreml_model = ct.convert(
            traced_image_model,
            inputs=[ct.TensorType(name="image", shape=dummy_image_input.shape)],
