...
if __name__ == "__main__":
    ...
    if args.new_ckpt_path is None:
        ...
        args.new_ckpt_path = "{}.state_dict{}".format(
            args.raw_ckpt_path[:-ext_len], args.raw_ckpt_path[-ext_len:]
        )
    ...
    print(
        "Transformed openai ckpt {} to {}!".format(
            args.raw_ckpt_path, args.new_ckpt_path
        )
    )
    print("Done!")
